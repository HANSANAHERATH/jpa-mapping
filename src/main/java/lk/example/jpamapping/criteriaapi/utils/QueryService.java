package lk.example.jpamapping.criteriaapi.utils;

import lk.example.jpamapping.criteriaapi.utils.filter.Filter;
import lk.example.jpamapping.criteriaapi.utils.filter.RangeFilter;
...
public class QueryService<ENTITY> {
     ...
     * @return a Specification
     */
    public Specification<ENTITY> buildStringSpecification(StringFilter filter, SingularAttribute<? super ENTITY, String> field) {
        return buildSpecification(filter, root -> root.get(field));
    }
     ...
     * @param entityToColumn   the function, which of the static metamodel of the referred entity, where the equality should be                         checked.
     * @return a Specification
     */
     ...
     * @return a Specification
     */
    public <OTHER, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(final RangeFilter<X> filter,
     ...
     * @return a Specification
     */
    public <OTHER, MISC, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(final RangeFilter<X> filter,
                                                                                                                     Function<Root<ENTITY>, SetJoin<MISC, OTHER>> functionToEntity,
                                                                                                                     Function<SetJoin<MISC, OTHER>, Expression<X>> entityToColumn) {
     ...
     * @return a Specification.
     */
    public <X> Specification<ENTITY> notEqualsSpecification(Function<Root<ENTITY>, Expression<X>> metaclassFunction, final X value) {
